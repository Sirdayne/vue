...
.cols
  el-menu.sidebar(
    ...
    router-link(:to="`/field?path=field-passport`")
      el-menu-item(:index="`3`") Диаграмма вегетации
    router-link(:to="`/field?path=field-passport`")
      el-menu-item(:index="`4`") Карты
    router-link(:to="`/field?path=field-passport`")
      el-menu-item(:index="`5`") Фото
    router-link(:to="`/field?path=field-passport`")
      el-menu-item(:index="`6`") История работ
    router-link(:to="`/field?path=field-passport`")
      el-menu-item(:index="`7`") Список заданий
    router-link(:to="`/field?path=field-passport`")
      el-menu-item(:index="`8`") История удобрений
    router-link(:to="`/field?path=field-passport`")
      el-menu-item(:index="`9`") История СЗР
    router-link(:to="`/field?path=field-passport`")
      el-menu-item(:index="`10`") Учет сорняков
    router-link(:to="`/field?path=field-passport`")
      el-menu-item(:index="`11`") Прогноз погоды
...
import FieldPassport from 'components/fieldpassport'
